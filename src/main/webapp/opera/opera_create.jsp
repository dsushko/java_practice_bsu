...
<div>
    <div>
        <form action="${pageContext.request.contextPath}/opera/add" method="post" style="width: 500px">
            ...
            <div>
                ...
                <input type="number" name="releaseCentury"/>
            </div>
            <div>
                <span>Orchestra count:</span>
                <input type="number" name="orchestraCount"/>
            </div>
            <div>
                <span>Voice type required</span>
                <input type="text" name="vocalVoiceTypeRequired"/>
            </div>
            <div>
                <span><10:</span>
