...
<div>
    <div>
        <form action="${pageContext.request.contextPath}/rap/post" method="post" style="width: 500px">
            ...
            <div>
                <span>BPM:</span>
                <input type="number" value="${song.bpm}" name="bpm"/>
            </div>
            <div>
                <span>Performer's race:</span>
                <input type="text" value="${song.performerRace}" name="performerRace"/>
            </div>
            <div>
                <span>Is performer alive?</span>
                <input type="checkbox" value="${song.performerAlive ? "on" : "null"}" name="performerAlive"/>
            </div>
            <div>
                <span>Performer's death type</span>
                <input type="text" value="${song.performerDeathType}" name="performerDeathType"/>
            </div>
            <div>
                <span><10:</span>
