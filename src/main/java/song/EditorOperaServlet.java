...
@WebServlet(name = "EditOperaServlet", value="/opera/edit")
public class EditorOperaServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try{
            ...
            Opera song = controller.GetSong(id);
            request.setAttribute("song", song);

            request.setAttribute("id", id);
            request.getRequestDispatcher("opera_edit.jsp").forward(request, response);
