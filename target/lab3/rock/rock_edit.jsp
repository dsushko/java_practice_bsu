...
<div>
    <div>
        <form action="${pageContext.request.contextPath}/rock/post" method="post" style="width: 500px">
            ...
            <div>
                <span>Subgenre:</span>
                <input type="text" value="${song.subGenre}" name="subGenre"/>
            </div>
            <div>
                <span>Guitar effects:</span>
                <input type="text" value="${song.guitarEffects}" name="guitarEffects"/>
            </div>
            <div>
                <span>Has extreme vocals?</span>
                <input type="checkbox" value="${song.hasExtremeVocals}" name="hasExtremeVocals"/>
            </div>
            <div>
                <span><10:</span>
